...
import { assert, AsyncMutex, binarySearchExact, binarySearchLessOrEqual, toDataView, UNDETERMINED_LANGUAGE, } from '../misc.js.js';
import { EncodedPacket, PLACEHOLDER_DATA } from '../packet.js.js';
import { getXingOffset, INFO, XING, XingFlags, computeAverageMp3FrameSize, getMp3ChannelCount, } from '../../shared/mp3-misc.js.js';
import { ID3_V1_TAG_SIZE, ID3_V2_HEADER_SIZE, parseId3V1Tag, parseId3V2Tag, readId3V2Header, } from '../id3.js.js';
import { readNextMp3FrameHeader } from './mp3-reader.js.js';
